          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2  pr-4 mb-8 md:mb-0">
              ...
              <h1 className="text-5xl text-black font-medium mb-6 leading-tight">
                Ace Intervie with <br />
                <span className="text-transparent bg-clip-text bg-[radial-gradient(circle,_#ff9324_0%,_#fcd760_100%)] bg-[length_200%_200%] animate-text-shine font-semibold">
                  AI-Powered
                </span>
                {""}
                Learning
            ...
            <div className="w-full md:w-1/2">
              <p className="text=[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                Get Role-Specific questions, expand answers, and ace your
                interviews with AI-powered learning. dive deeper into concepts,
                and organize everything your way. From Preparation to mastery -
                your ultimeate interview toolkit is here
              </p>
              <button
                onClick={handleCTA}
...
<div className="flex flex-col items-center mb-12">
  <hr className="w-20 bg-amber-300 border-none h-1 rounded-lg mb-2" />
